...
define('CAMPAIGN_ID', "6a4aaca4924899bbcdc18af9f1dd8fea");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '9603900512cd9c9bea9b34bc41366db4');
define('MP_PARAM_NAME', '__rhid');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '0049fcb716c65b6c25ae10f9331d2ea1');
define('CHECK_MCPROXY_VALUE', '2ee03ae2d342b02c0bc933c86a0c54dea1bcfd493f1ea2c69654d0d4d1b19809');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '1353.2');
